...
var subtitles = require('srt-to-vtt/srttovtt');
...
app.use(express.static(dir)); //le disque dur avec les fichiers accessibles
app.use(express.static(__dirname));//le dossier ou le doc html peut envoyer des requetes (css, autres js, ...)
...
app.get('/files', function(req, res) { //reception du fichier XHR avec la liste des fichiers.
    ...
    subtitles.changesrt(req.query.path);
});
